...
`
    ...
    (async () => {
      const { textStream } = await streamText({
          ...
          prompt: `
          You are an AI code assistant who answers questions about the codebase. Your target audience is a technical intern who needs help understanding the project.
